...
contract ProxyRegistry is Ownable {
    ...
    AuthenticatedProxy public delegateProxyImplementation;
...
contract WyvernProxyRegistryN is ProxyRegistry {
...
contract AuthenticatedProxy is TokenRecipient, OwnedUpgradeabilityStorage {
    ...
    function proxy(
        ...
        if (howToCall == HowToCall.Call) {
            ...
            (result,) = dest.delegatecall(calldata_);
        }
        return result;
    }
     ...
     * @param calldata_ Calldata to send
     */
    function proxyAssert(
        ...
        require(proxy(dest, howToCall, calldata_));
    }
}
...
contract OwnableDelegateProxy is OwnedUpgradeabilityProxy {
    constructor(
        ...
        (bool res,) = initialImplementation.delegatecall(calldata_);
        require(res);
    }
}
